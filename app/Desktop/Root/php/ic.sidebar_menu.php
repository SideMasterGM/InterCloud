...
<ul class="nav sidebar-menu">
    ...
    <ul class="nav sub-nav">
      ...
      <li>
        <a href="widgets_scroller.html">
          <span class="fa fa-columns"></span> ... </a>
      </li>
      <li>
        <a href="widgets_data.html">
          <span class="fa fa-dot-circle-o"></span> ... </a>
      </li>
    </ul>
  </li>
  <li>
    ...
    <ul class="nav sub-nav">
      ...
      <li>
        <a href="ui_animations.html">
          <span class="fa fa-spinner"></span> ... </a>
      </li>
      <li>
      ...
      <li>
        <a href="ui_typography.html">
          <span class="fa fa-text-width"></span> ... </a>
      </li>
      <li>
      ...
      <li>
        <a href="ui_tabs.html">
          <span class="fa fa-toggle-off"></span> ... </a>
      </li>
      <li>
    ...
    <ul class="nav sub-nav">
      ...
      <li>
        <a href="form_uploaders.html">
          <span class="fa fa-cloud-upload"></span> ... </a>
      </li>
      <li>
  ...
  <li>
    ...
    <ul class="nav sub-nav">
      <li>
        ...
        <ul class="nav sub-nav">
          <li>
            <a href="maps_advanced.html">...</a>
          </li>
          <li>
            <a href="maps_basic.html">...</a>
          </li>
          <li>
            <a href="maps_vector.html">...</a>
          </li>
          <li>
            <a href="maps_full.html">...</a>
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul class="nav sub-nav">
          <li>
            <a href="charts_highcharts.html">...</a>
          </li>
          <li>
            <a href="charts_d3.html">...</a>
          </li>
          <li>
            <a href="charts_flot.html">...</a>
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul class="nav sub-nav">
          <li>
            <a href="tables_basic.html">...</a>
          </li>
          <li>
            <a href="tables_datatables.html"> ... </a>
          </li>
          <li>
            <a href="tables_datatables-editor.html"> ... </a>
          </li>
          <li>
            <a href="tables_footable.html"> ... </a>
          </li>
          <li>
            <a href="tables_pricing.html"> ... </a>
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul class="nav sub-nav">
          <li>
            <a href="misc_tour.html">...</a>
          </li>
          <li>
            <a href="misc_timeout.html"> ... </a>
          </li>
          <li>
            <a href="misc_nprogress.html"> ... </a>
          </li>
        </ul>
      </li>
    </ul>
  ...
  <li class="sidebar-stat">
    <a href="#projectOne" class="fs11">
      ...
      <span class="sidebar-title text-muted">Localhost</span>
